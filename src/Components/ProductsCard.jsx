...
const ProductsCard = () => {
  ...
  return prodData.length === 0 ? (
    ...
    <>
      <div className="flex flex-wrap justify-center text-center w-[80%] mx-auto space-x-3 space-y-5 mt-4  ">
        {prodData.map((items) => {
          ...
          return (
            <>
              <Link to={`/singleProduct/${id}`}>
                <div
                  key={id}
                  className=" hover:shadow-lg transition-all duration-300 py-2 rounded-xl cursor-pointer  "
                >
